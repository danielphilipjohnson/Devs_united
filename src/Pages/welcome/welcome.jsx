    ...
    return (
        <div className="home">
            ...
            <div className="login">
                ...
                <label htmlFor="colors" className="login_colors">Select your favorite color</label>
                <div id="colors" className="colors-container">
                    <div className="color pink"  onClick={() => setColors('pink')}></div>
                    <div className="color orange" onClick={() => setColors('orange')}></div>
                    <div className="color yellow" onClick={() => setColors('yellow')}></div>
                    <div className="color green" onClick={() => setColors('green')}></div>
                    <div className="color blue"  onClick={() => setColors('blue')}></div>
                    <div className="color purple" onClick={() => setColors('purple')}></div>
                </div>
